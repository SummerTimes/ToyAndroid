...
public class LuCryptoUtil {

    private static final String TAG = LuCryptoUtil.class.getSimpleName();
    ...
    public static String genMD5Str(String str) {
        ...
        return LuStringUtils.bytesToHexString(md5Bytes);
    }
    ...
    public static String genSHAStr(String str) {
        ...
        return LuStringUtils.bytesToHexString(digest);
    }
    ...
    public static String encryAES(String value, String key) {
        ...
        return LuStringUtils.bytesToHexString(data);
    }
