...
import com.kk.app.lib_permission.avy.PrTransActivity;
...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(PrUtils.getApp().getPackageName());
    }
    ...
    public static List<String> getPermissions(final String packageName) {
        PackageManager pm = PrUtils.getApp().getPackageManager();
        try {
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(PrUtils.getApp(), permission);
    }
    ...
    public static boolean isGrantedWriteSettings() {
        return Settings.System.canWrite(PrUtils.getApp());
    }
    ...
    private static void startWriteSettingsActivity(final Activity activity, final int requestCode) {
        ...
        intent.setData(Uri.parse("package:" + PrUtils.getApp().getPackageName()));
        if (!PrIntentUtil.isIntentAvailable(intent)) {
    ...
    public static boolean isGrantedDrawOverlays() {
        return Settings.canDrawOverlays(PrUtils.getApp());
    }
    ...
    public static void launchAppDetailsSettings() {
        Intent intent = PrIntentUtil.getLaunchAppDetailsSettingsIntent(PrUtils.getApp().getPackageName(), true);
        if (!PrIntentUtil.isIntentAvailable(intent)) {
            return;
        }
        PrUtils.getApp().startActivity(intent);
    }
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    private boolean shouldRationale(final PrTransActivity activity, final Runnable againRunnable) {
    ...
    private void rationalInner(final PrTransActivity activity, final Runnable againRunnable) {
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    static final class PermissionActivityImpl extends PrTransActivity.TransActivityDelegate {
        ...
        public static void start(final int type) {
            PrTransActivity.start(new PrUtils.Consumer<Intent>() {
                @Override
        ...
        @Override
        public void onCreated(@NonNull final PrTransActivity activity, @Nullable Bundle savedInstanceState) {
        ...
        private void requestPermissions(final PrTransActivity activity) {
        ...
        @Override
        public void onRequestPermissionsResult(@NonNull PrTransActivity activity,
                                               int requestCode,
        ...
        @Override
        public void onDestroy(@NonNull final PrTransActivity activity) {
    ...
    public interface OnExplainListener {
        ...
        void explain(@NonNull PrTransActivity activity, @NonNull List<String> denied, @NonNull ShouldRequest shouldRequest);
    ...
    public interface OnRationaleListener {
        ...
        void rationale(@NonNull PrTransActivity activity, @NonNull ShouldRequest shouldRequest);
