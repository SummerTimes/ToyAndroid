...
public class LuckyDrawView extends RelativeLayout {
    ...
    public LuckyDrawView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        Drawable startBackground = a.getDrawable(R.styleable.LuckyDrawView_startBackgroud);
        Drawable prizeBackground = a.getDrawable(R.styleable.LuckyDrawView_prizeBackgroud);
        a.recycle();
        ...
        if (startBackground == null) {
            ...
            mStart.setBackgroundDrawable(startBackground);
        }
        for (int i = 0; i < mLuckyDrawItem.length; i++) {
            if (prizeBackground == null) {
                ...
                mLuckyDrawItem[i].setBackgroundDrawable(prizeBackground);
            }
        }
    }
    ...
    private void init() {
        ...
        mStart = findViewById(R.id.v_lucky_draw_view_start);
        mStart.setOnClickListener(onClickStart());

        mLuckyDrawItem[0] = findViewById(R.id.ld_lucky_draw_view_1);
        mLuckyDrawItem[1] = findViewById(R.id.ld_lucky_draw_view_2);
        mLuckyDrawItem[2] = findViewById(R.id.ld_lucky_draw_view_3);
        mLuckyDrawItem[3] = findViewById(R.id.ld_lucky_draw_view_4);
        mLuckyDrawItem[4] = findViewById(R.id.ld_lucky_draw_view_5);
        mLuckyDrawItem[5] = findViewById(R.id.ld_lucky_draw_view_6);
        mLuckyDrawItem[6] = findViewById(R.id.ld_lucky_draw_view_7);
        mLuckyDrawItem[7] = findViewById(R.id.ld_lucky_draw_view_8);
    }
     ...
     */
    public void setStartBackgroundResource(int resid) {
        if (mStart != null) {
     ...
     */
    public void setStartBackgroundColor(int color) {
        if (mStart != null) {
     ...
     * @param color
     */
    public void setPrizeBackgroundColor(int color) {
        if (mLuckyDrawItem != null) {
            for (int i = 0; i < mLuckyDrawItem.length; i++) {
